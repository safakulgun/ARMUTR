...
df_ = pd.read_csv("C:/Users/sfkul/Downloads/ArmutARL-230107-082516/ArmutARL-221114-234936/armut_data.csv")
df = df_.copy()
df.head()
...
def arl_recommender(rules_df, product_id, rec_count=1):
    ...
    print(sorted_rules)
    print(type(sorted_rules["antecedents"]))
    print(hasattr(sorted_rules["antecedents"], "items"))
...
arl_recommender(rules_df,"2_0", 4)